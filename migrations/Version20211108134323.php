 ...
 */
final class Version20211108134323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dommage (id INT AUTO_INCREMENT NOT NULL, le_controle_id INT DEFAULT NULL, le_element_id INT DEFAULT NULL, la_gravite_id INT DEFAULT NULL, INDEX IDX_EDA85F8534AE5CB9 (le_controle_id), INDEX IDX_EDA85F853C1F558F (le_element_id), INDEX IDX_EDA85F85B4A9E42 (la_gravite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
